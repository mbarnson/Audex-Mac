Feature: Licensing
  ...
  @fast
  Scenario: Licensing documentation distinguishes project and model licenses
    ...
    And it says NVIDIA model weights are governed by NVIDIA's license
    And it links to the Audex model cards
